...
const Navbar = () => {
    ...
    const isMobile = useMediaQuery("(max-width:600px)"); // Kiểm tra kích thước màn hình nhỏ hơn 600px
                        ...
                        >
                            {["Home", "Tour", "Blog", "Gallery", "About Us", "Sponsor"].map((item, index) => (
                                ...
                                >
                                    ...
                                    {showDropdown === "Home" && <DropdownListHome />}
                                    {showDropdown === "Tour" && <DropdownListTour />}
                                    {showDropdown === "Blog" && <DropdownListBlog />}
                                </Box>
                            ))}
                        </Box>
                    )}
